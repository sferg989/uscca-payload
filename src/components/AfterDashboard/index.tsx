	...
	return (
		<div className='after-dashboard'>
			...
			<p>
				...
				Discord community. It can be a great resource to learn about what's happening with Payload before anyone else
				and get quick help straight from the Payload team as well as our community.{' '}
